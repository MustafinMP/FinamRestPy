...
class AccountService(BaseService):
    ...
    def get_trades(self, end_time: datetime, start_time: datetime = None, limit: int = None) -> list[TradeSchema]:
        ...
        if response.status_code == 200:
            return [TradeSchema.from_dict(t) for t in response.json()['trades']]
        return None
